...
-- =========================================
-- Extra tables for project: PopularFood
-- =========================================
DROP TABLE IF EXISTS PopularFood;

CREATE TABLE PopularFood (
    CountryCode CHAR(3) NOT NULL,
    NationalDish VARCHAR(100) NOT NULL,
    CuisineType  VARCHAR(50),
    PRIMARY KEY (CountryCode),
    FOREIGN KEY (CountryCode) REFERENCES Country(Code)
);

INSERT INTO PopularFood (CountryCode, NationalDish, CuisineType) VALUES
('USA', 'Hamburger', 'American'),
('MEX', 'Mole Poblano', 'Mexican'),
('CAN', 'Poutine', 'Canadian'),
('BRA', 'Feijoada', 'Brazilian'),
('ARG', 'Asado', 'Argentinian'),
('ITA', 'Risotto alla Milanese', 'Italian'),
('FRA', 'Pot-au-Feu', 'French'),
('ESP', 'Paella Valenciana', 'Spanish'),
('GBR', 'Roast Beef and Yorkshire Pudding', 'British'),
('DEU', 'Sauerbraten', 'German'),
('JPN', 'Kare Raisu (Japanese Curry)', 'Japanese'),
('KOR', 'Kimchi', 'Korean'),
('IND', 'Khichdi', 'Indian'),
('CHN', 'Peking Duck', 'Chinese'),
('AUS', 'Meat Pie', 'Australian'),
('THA', 'Pad Thai', 'Thai'),
('TUR', 'Doner Kebab', 'Turkish'),
('GRC', 'Moussaka', 'Greek'),
('RUS', 'Pelmeni', 'Russian'),
('EGY', 'Koshari', 'Egyptian');



-- =========================================
-- Extra tables for project: Flag
-- =========================================
DROP TABLE IF EXISTS Flag;
...
SELECT c.Name AS CountryName, cl.Language, pf.NationalDish
FROM Country c
...
-- Query 4: Countries with national dishes whose population is above world average Subquery #1
SELECT c.Name AS CountryName, pf.NationalDish, c.Population
FROM Country c
JOIN PopularFood pf ON c.Code = pf.CountryCode
WHERE c.Population > (SELECT AVG(Population) FROM Country)
ORDER BY c.Population DESC;

-- Query 5: Countries with national dishes whose life expectancy is above their continent average Subquery #2
SELECT c.Name AS CountryName, c.Continent, pf.NationalDish, c.LifeExpectancy
FROM Country c
JOIN PopularFood pf ON c.Code = pf.CountryCode
